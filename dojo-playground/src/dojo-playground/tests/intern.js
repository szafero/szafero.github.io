...
define({
	...
	loader: {
		...
		packages: [
			...
			{ name: 'dojo-playground', location: 'src/dojo-playground' }
		]
	},

	// Non-functional test suite(s) to run in each browser
	suites: [ 'dojo-playground/tests/unit' ],

	// Functional test suite(s) to run in each browser once non-functional tests are completed
	functionalSuites: [ 'dojo-playground/tests/functional' ],

	// A regular expression matching URLs to files that should not be included in code coverage analysis
	excludeInstrumentation: /^(?:node_modules|src\/(?:dojo|dijit|put-selector|xstyle|dgrid|dojo-playground\/tests))\//
});
